...
/**
 * Created by xavier on 8/20/15.
 */
public class GetResultSetTest {

    private String json;


    @Test
    public void whenProvideClassAndJson_ShouldUseTheKeyProvided() {
        List<VersionDTO> versionDTOs = TolerantReader.getResultSetByClass(VersionDTO.class, json);
        Assert.assertTrue(versionDTOs.size() == 1);
